    ...
    this.html = `
      <div class="library-header">
        <div>
          ...
          <p class="library-sub">Pick your poison. 35 ways to test your limits.</p>
        </div>
        <div class="library-stats">
          <div class="lib-stat">
            <span class="lib-stat-num" id="total-games-stat">35</span>
      ...
      <div class="showing-text" id="showing-text">Showing 35 of 35 games</div>
